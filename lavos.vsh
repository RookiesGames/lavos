...
fn cmd_link(cmd cli.Command) ! {
	...
	println(lavoswd)
	// lavos source
	create_symlink('$lavoswd/godot', '$path/$symlink_lavos')!
	// script templates
	create_symlink('$lavoswd/$symlink_script_templates', '$path/$symlink_script_templates')!
	// addons
	create_path('$path/addons')!
	create_symlink('$lavoswd/addons', '$path/addons/$symlink_lavos')!
	// plugins
	create_path('$path/android')!
	create_symlink('${lavoswd}/plugins/android/godot', '$path/android/plugins') !
	//create_path('$path/ios')!
	//create_symlink('$lavoswd/plugins/ios/godot', '$path/ios/plugins')!
	//
